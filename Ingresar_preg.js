...
$(document).ready(function(){ 
	$('#btn').click(function(){ // prepare button inserts the JSON string in the hidden element 
		...
		rta4.pop();
		//alert("hola");
		$('#preg').val(JSON.stringify(preg));
		/*var pruebaa = document.getElementById("preg").value;
		alert(pruebaa);*/
		$('#rta1').val(JSON.stringify(rta1));
		$('#rta2').val(JSON.stringify(rta2));
		$('#rta3').val(JSON.stringify(rta3));
		$('#rta4').val(JSON.stringify(rta4));
	}); 
});
