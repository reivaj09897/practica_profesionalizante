...
<?php
	...
	if($_POST['idexamen'] !== "") { 
		...
		$sql= "SELECT (SELECT usuario FROM u_alumno a, mc_puntuacion b WHERE a.id_alumno = b.id_alumno AND b.id_examen = '".$_POST['idexamen']."' LIMIT 1) as alumno, (SELECT nom_examen FROM mc_examen WHERE id_examen = '".$_POST['idexamen']."' LIMIT 1) as examen, puntaje FROM `mc_puntuacion` WHERE id_examen = '".$_POST['idexamen']."';";
